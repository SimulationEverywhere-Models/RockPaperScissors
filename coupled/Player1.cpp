...
shared_ptr<dynamic::modeling::model> actionMaker1 = dynamic::translate::make_dynamic_atomic_model<ActionMaker,TIME,int>("actionMaker1");
...
dynamic::modeling::EOCs eocs_Player1 = {
	dynamic::translate::make_EOC<Comparer_defs::gameActionIn1,Player1_defs::gameActionOut>("actionMaker1")
};
