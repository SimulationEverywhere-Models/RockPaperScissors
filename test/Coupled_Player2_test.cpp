...
int main(){
    ...
    dynamic::modeling::Models submodels_TOP = {input_reader,Player2};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
        dynamic::translate::make_EOC<Player2_defs::gameActionOut,top_out>("Player2")
		};
    dynamic::modeling::ICs ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<PlayGame_t>::out,Player2_defs::playGameIn>("input_reader","Player2")
	};
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/COUPLED_TEST_PLAYER2_outputs.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/COUPLED_TEST_PLAYER2_state.txt");
