...
int main(){
    ...
    submodels_TOP = {input_reader, requestReceiver1};
    dynamic::modeling::EICs eics_TOP;
    eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP;
    eocs_TOP = {
        dynamic::translate::make_EOC<RequestReceiver_defs::playGameOut,top_out>("requestReceiver1")
    };
    dynamic::modeling::ICs ics_TOP;
    ics_TOP = {
        dynamic::translate::make_IC<iestream_input_defs<PlayGame_t>::out,RequestReceiver_defs::playGameIn>("input_reader","requestReceiver1")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/requestReceiver_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){          
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/requestReceiver_test_output_state.txt");
